(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "hazyShadeOfSpring-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "hazyShades@email.com"; // Your Business PayPal's account email address
